...
urlpatterns = [
    ...
    url(r'^ajax/save_edited_image_checkdams$', views.save_edited_image_checkdams, name='save_edited_image_checkdams'),   
    ...
    # url(r'^labelwells$', views.labelwellselWells, name='labelWells'),
    url(r'^editannotscheckdams$', views.editAnnotsCD, name='editAnnotsCD'),    
    ...
    url(r'^checkResolution$', views.checkResolution, name='checkResolution'),
    ...
    url(r'^downloaddatasetwellscoco1$', views.downloadDatasetWellsCOCO1, name='downloadDatasetWellsCOCO1'),
    ...
    url(r'^downloaddatasetfarmpondscoco1$', views.downloadDatasetFPCOCO1, name='downloadDatasetFPCOCO1'),
    ...
    url(r'^downloaddatasetcheckdamscoco1$', views.downloadDatasetCDCOCO1, name='downloadDatasetCDCOCO1'),
    url(r'^downloaddatasetcheckdams$', views.downloadDatasetCheckdams, name='downloadDatasetCheckdams'),
    url(r'^downloaddatasetcheckdamsyolo$', views.downloadDatasetCDYOLO, name='downloadDatasetCDYOLO'),
    url(r'^downloaddatasetcheckdamscustom2$', views.downloadDatasetCDCustom2, name='downloadDatasetCDCustom2'),
    url(r'^testCode$', views.testCode, name='testCode'),
    url(r'^saveCDfromDStoDB$', views.saveCDfromDStoDB, name='saveCDfromDStoDB')
